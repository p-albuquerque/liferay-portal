...
public class ObjectDefinitionGraphQLTest {
	...
	public void setUp() throws Exception {
		...
		ObjectFieldLocalServiceUtil.addCustomObjectField(
			...
			false, _listFieldName, ObjectFieldConstants.READ_ONLY_FALSE, null, true, false, Collections.emptyList());
	...
	private ObjectDefinition _addObjectDefinition() throws Exception {
		...
		ObjectFieldLocalServiceUtil.addCustomObjectField(
			...
			LocalizedMapUtil.getLocalizedMap(RandomTestUtil.randomString()),
			false, _objectFieldName, ObjectFieldConstants.READ_ONLY_FALSE, null, false, false, Collections.emptyList());
