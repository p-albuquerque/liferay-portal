...
public class ObjectViewLocalServiceTest {
	...
	public void testAddObjectView() throws Exception {
		...
		try {
			...
			Assert.assertEquals(
				"There is no object field with the name: noExistedField",
		...
		try {
			...
			Assert.assertEquals(
				"Already exist object view column with field name: roger",
				objectViewColumnException.getMessage());
		}
	...
	private ObjectViewColumn
		...
		objectViewColumn.setObjectFieldName("noExistedField");
